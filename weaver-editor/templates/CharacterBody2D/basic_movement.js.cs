...
const { _BASE_, ProjectSettings, Input, move_toward, Variant } = require("godot");
const { export_ } = require("jsb.core");
...
export_(Variant.Type.TYPE_FLOAT)(_CLASS_.prototype, "speed");
