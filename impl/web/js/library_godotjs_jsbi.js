...
const GodotJSBrowserInterface = {
    ...
    "jsbi_PromiseResolverGetPromise": function (engine_id, resolver_sp) { return _jsbb_.GetEngine(engine_id).PromiseResolverGetPromise(resolver_sp); },
    "jsbi_PromiseResolverResolve": function (engine_id, resolver_sp, value_sp) { return _jsbb_.GetEngine(engine_id).PromiseResolverResolve(resolver_sp, value_sp); },
    "jsbi_PromiseResolverReject": function (engine_id, resolver_sp, value_sp) { return _jsbb_.GetEngine(engine_id).PromiseResolverReject(resolver_sp, value_sp); },
