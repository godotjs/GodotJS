...
namespace v8
{
    ...
    {
        const JSObjectRef this_obj = jsb::impl::JavaScriptCore::AsObject(isolate_->ctx(), (JSValueRef) * this);
        isolate_->_DefineProperty(this_obj, (JSValueRef) name, jsb::impl::JavaScriptCore::AsObject(isolate_->ctx(), (JSValueRef) getter), jsb::impl::JavaScriptCore::AsObject(isolate_->ctx(), (JSValueRef) setter));
    }
