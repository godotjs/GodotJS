...
#   define V8_VERSION_STRING "quickjs-ng-"  JSB_STRINGIFY(QJS_VERSION_MAJOR) "." JSB_STRINGIFY(QJS_VERSION_MINOR) "." JSB_STRINGIFY(QJS_VERSION_PATCH) QJS_VERSION_SUFFIX
#else 
